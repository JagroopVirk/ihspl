...
export default {
  ...
  image: {
    ...
    caption:
      "Science-based contamination control strategies for multi-product facilities.",
  },
  pageContent: {
    hero: {
      heading:
        "Cross-Contamination Risk Management for <span class='halfHeading'>Pharmaceutical Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Contamination <span class='halfHeading'>Control</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Risk Management Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Cross-Contamination <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Mitigate <span class='halfHeading'>Contamination Risks?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Robust Compliance Solutions",
  ...
  schema: {
    ...
    description:
      "Complete contamination control solutions from scientific assessment to facility implementation.",
    serviceType: [
      "Risk Assessment",
      "Facility Design",
      "Regulatory Compliance",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Comprehensive evaluation of contamination risks across all products and processes.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Full methodology application with documented risk controls and monitoring plans.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Scientifically justified exposure limits for all products in shared spaces.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Engineering solutions for contamination control (HVAC, workflow, segregation).",
  ...
  meta: {
    title:
      "Pharmaceutical Cross-Contamination Risk Assessment | HBEL & Risk-MaPP Experts - Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Complete contamination risk solutions from HBEL analysis to facility implementation.",
      image: `https://www.indivirtus.com${link}.jpg`,
      site: "@indivirtus",
      creator: "@indivirtus",
    },
