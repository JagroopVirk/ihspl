...
export default {
  ...
  image: {
    ...
    caption:
      "Science-based OEB determination for safe handling of potent active ingredients.",
  },
  pageContent: {
    hero: {
      heading:
        "OEB Assessment for <span class='halfHeading'>Pharmaceutical Safety</span>",
    ...
    cta: {
      heading:
        "Ready to Enhance <span class='halfHeading'>Worker Safety?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert OEB Solutions",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Multi-framework evaluation using ISPE, SafeBridge and NIOSH methodologies.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Specialized evaluation for highly potent active pharmaceutical ingredients.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Facility-specific engineering controls and workflow recommendations.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Complete PPE program and exposure monitoring recommendations.",
  ...
  meta: {
    title:
      "Expert OEB Classification Services | ISPE & SafeBridge Aligned - Indivirtus",
    description:
