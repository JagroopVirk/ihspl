...
export default {
  ...
  image: {
    ...
    caption:
      "Science-based OELs with comprehensive exposure control strategies for worker safety.",
  },
  pageContent: {
    hero: {
      heading:
        "OEL Assessment for <span class='halfHeading'>Worker Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Occupational <span class='halfHeading'>Exposure Control</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Worker Safety?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert OEL Solutions",
  ...
  schema: {
    ...
    description:
      "Comprehensive OEL determination with exposure modeling and containment strategy development.",
    serviceType: [
      "Risk Assessment",
      "Occupational Safety",
      "Regulatory Compliance",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Route-specific exposure limits with toxicological justification.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Airborne dispersion simulations for real-world scenarios.",
  ...
  meta: {
    title:
      "Expert OEL Determination Services | Exposure Modeling & Containment - Indivirtus",
    description:
