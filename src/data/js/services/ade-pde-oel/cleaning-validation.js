...
export default {
  ...
  image: {
    ...
    caption:
      "Science-based cleaning validation solutions for regulatory compliance and patient safety.",
  },
  gtm: {
  ...
  pageContent: {
    hero: {
      heading:
        "Cleaning Validation for <span class='halfHeading'>Pharmaceutical Purity</span>",
      tagline:
        "Ensure Contamination-Free Manufacturing with Tailored Solutions",
      detail:
    ...
    deliverables: {
      heading:
        "Cleaning Validation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Contamination-Free Manufacturing?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Robust Validation Excellence",
  ...
  schema: {
    ...
    description:
      "Complete cleaning validation packages from scientific assessment to regulatory documentation.",
    serviceType: [
      "Validation Service",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Complete cleaning validation approach using health-based exposure limits.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Scientific determination of maximum allowable carryover between products.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Assessment of swab/rinse methods for recovery and suitability.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Gap analysis against current EMA/FDA/PIC/S requirements.",
  ...
  meta: {
    title:
      "Pharmaceutical Cleaning Validation Support | HBEL & PDE Experts - Indivirtus",
    description:
