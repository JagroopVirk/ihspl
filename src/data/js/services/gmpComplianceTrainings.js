...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        'Pharmaceutical Quality & <span class="halfHeading">Compliance Training</span>',
    ...
    cta: {
      ...
      tagline:
        "Partner with us to deliver expert training tailored to your needs.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Principles, protocols, execution and acceptance criteria for cleaning in pharma operations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Overview and practical compliance of GxP requirements across pharmaceutical systems.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Detailed review of India’s Revised Schedule M: requirements and implementation.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Building data-centric quality culture: ALCOA+, risk awareness and compliance mindset.",
          },
        },
        {
          "@type": "Offer",
