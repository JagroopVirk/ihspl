...
export default {
  ...
  estimated_duration:
    "4-12 weeks depending on facility size and regulatory scope",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "GMP audit preparation and remediation support for global authorities",
  },
  pageContent: {
    hero: {
      heading:
        'GMP Approval & <span class="halfHeading">Compliance Services</span>',
      tagline:
        "Streamlining Regulatory Approvals for Pharmaceutical Excellence",
    },
    main: {
      ...
      steps: [
        {
          ...
          description:
            "We assess your facility, processes, and regulatory goals to tailor our GMP services.",
        },
        {
        ...
        },
        {
          ...
          description:
            "We prepare and review regulatory dossiers, ensuring readiness for submissions and inspections.",
        },
        {
          title: "Ongoing Compliance Support",
          description:
            "We provide continuous support for audits, CAPA implementation, and regulatory query responses.",
        },
      ],
    },
    compliance: {
    ...
    cta: {
      ...
      tagline:
        "Let us guide you through regulatory approvals with confidence and precision.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Detailed GAP analysis of facility and documentation per India’s Schedule M guidelines.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "GMP audit and documentation readiness support for EU, US, WHO, TGA, ANVISA, COFEPRIS and more.",
      image: `https://www.indivirtus.com${baseLink}.jpg`,
    },
