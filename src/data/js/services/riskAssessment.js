...
export default {
  ...
  estimated_duration:
    "2–6 weeks (depending on data availability and number of substances)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Expert ICH and ISO-aligned toxicological assessments for impurities and medical devices",
  },
  pageContent: {
    hero: {
      heading:
        'Genotoxicity Risk Assessment & <span class="halfHeading">Medical Device Toxicity Assessment</span>',
      tagline:
        "Unrivaled expertise in genotoxic impurity evaluation and toxicological risk assessment",
    },
    main: {
      heading:
        'Why Our <span class="halfHeading">CRO Services Stand Out</span>',
      detail:
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "Prepare ICH-compliant documentation for global submissions",
        },
        {
          title: "Final Delivery",
          description:
            "Provide actionable risk assessments and stability reports",
        },
      ],
    },
    compliance: {
    ...
    cta: {
      ...
      tagline:
        "Partner with Indivirtus for innovative, compliant CRO solutions.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Assessment and justification of metal impurities in line with ICH Q3C/Q3D guidelines.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "In silico and literature-based risk assessment of genotoxic impurities per ICH M7.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Toxicological relevance of E&L studies for device safety across product lifecycle.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "Comprehensive toxicological evaluations for impurities and devices using ICH & ISO standards.",
      image: `https://www.indivirtus.com${baseLink}.jpg`,
    },
