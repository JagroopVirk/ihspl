...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "MAH & QP Support for <span class='halfHeading'>EU/UK Compliance</span>",
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>EU/UK PV Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert MAH & QP Solutions",
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "Expert MAH, QP, and pharmacovigilance services for EU/UK pharma compliance.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
