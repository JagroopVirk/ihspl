...
export default {
  ...
  name: "CEP/DMF Filing",
  description:
    "Expert support in CEP, DMF (Type I-V), and ASMF filings for global pharmaceutical compliance.",
  full_description:
  ...
  pageContent: {
    hero: {
      heading:
        "CEP, DMF & ASMF Filings for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering CEP, DMF & <span class='halfHeading'>ASMF Excellence</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>Global Filings?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert CEP, DMF, and ASMF Solutions",
