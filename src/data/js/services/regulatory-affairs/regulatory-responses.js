...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Regulatory Responses for <span class='halfHeading'>Compliance Success</span>",
    ...
    overview: {
      heading: "Mastering Regulatory <span class='halfHeading'>Response Strategies</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading: "Regulatory Responses <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Address Your <span class='halfHeading'>Regulatory Queries?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services for Expert Response Solutions',
