...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Global Regulatory Strategy for <span class='halfHeading'>Market Success</span>",
    ...
    overview: {
      heading:
        "Mastering Global <span class='halfHeading'>Regulatory Planning</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Navigate Your <span class='halfHeading'>Regulatory Pathway?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Strategy Solutions",
  ...
  meta: {
    title:
      "Regulatory Strategy Services | Global Regulatory Consulting | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "End-to-end global regulatory strategy services for pharma and biotech companies.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
