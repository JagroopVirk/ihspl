...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "CTD & ACTD Dossier Preparation for <span class='halfHeading'>Global Submissions</span>",
    ...
    overview: {
      heading:
        "Mastering Dossier <span class='halfHeading'>Preparation Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Dossier Preparation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      ...
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Dossier Solutions",
  ...
  meta: {
    title:
      "CTD & ACTD Dossier Preparation | eCTD Publishing Services | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "ICH-compliant CTD/ACTD dossier preparation and eCTD publishing support for pharma products.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
