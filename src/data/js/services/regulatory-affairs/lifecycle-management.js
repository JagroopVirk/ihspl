...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Pharmaceutical Lifecycle Management for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Pharmaceutical <span class='halfHeading'>Lifecycle Management</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Lifecycle Management <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Sustain Your <span class='halfHeading'>Product Lifecycle?</span>",
      tagline:
  ...
  meta: {
    title:
      "Pharmaceutical Lifecycle Management | Variations, Renewals & Labeling | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Post-approval lifecycle services: regulatory variations, renewals, labeling, and change control.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
