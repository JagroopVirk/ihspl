...
export default {
  ...
  description:
    "Precise calibration services for critical pharmaceutical instruments, backed by NABL accreditation.",
  full_description:
  ...
  estimated_duration:
    "2-5 business days per instrument (depends on queue and scope)",
  deliverables: [
  ...
  pageContent: {
    hero: {
      heading:
        'NABL-Accredited <span class="halfHeading">Calibration Services</span>',
      tagline:
        "Precision Calibration for Pharmaceutical Excellence and Regulatory Compliance",
    },
    main: {
    ...
    cta: {
      ...
      tagline:
        "Let us help you achieve compliance and accuracy with our expert calibration services.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Calibration of thermal sensors and chambers across pharma labs and utilities.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Calibrating meters measuring AC/DC current, voltage, resistance, frequency, time, etc.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Precision calibration of gauges for length, speed, sound, and dimension.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Calibration of pressure, vacuum, magnehelic gauges, transmitters, safety valves.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Calibration of weigh scales, pipettes, burettes and volumetric devices.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Calibration of chemical and process meters like pH, conductivity, TDS, and flow instruments.",
          },
        },
      ],
    },
