...
export default {
  ...
  estimated_duration:
    "2–8 weeks per system/project, depending on scope & complexity",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "CSV, equipment, EMS, and HVAC validation tailored for pharmaceutical labs",
  },
  pageContent: {
    hero: {
      heading:
        'Validation Services for <span class="halfHeading">Pharma & Biotech</span>',
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "We create Validation Master Plans, DQ/IQ/OQ/PQ protocols, and risk assessments per GAMP 5.",
        },
        {
        ...
        },
        {
          ...
          description:
            "We provide traceability matrices, summary reports, and audit-ready documentation.",
        },
        {
    ...
    conclusion: {
      heading:
        'Why Choose Our <span class="halfHeading">Validation Services?</span>',
      detail:
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "IQ/OQ/PQ protocols and validation for analytical instruments.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "CSV of automation platforms including risk assessment and data integrity.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Qualification of systems capturing environmental and process data.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Computer system validation to meet GxP and Part 11 requirements.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Mapping and qualification of temperature-controlled zones and equipment.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "DOP testing, air changes, velocity mapping and filter integrity testing for cleanrooms.",
          },
        },
      ],
    },
