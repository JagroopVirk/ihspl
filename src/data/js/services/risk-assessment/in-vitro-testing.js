...
export default {
  ...
  image: {
    ...
    caption:
      "OECD-aligned in vitro assays for regulatory mutagenicity evaluations.",
  },
  pageContent: {
    hero: {
      heading:
        "In Vitro Genotoxicity Testing for <span class='halfHeading'>Regulatory Safety</span>",
    ...
    overview: {
      heading:
        "Mastering In Vitro <span class='halfHeading'>Genotoxicity Testing</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>In Vitro Testing Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "In Vitro Genotoxicity <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      ...
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert In Vitro Testing Solutions",
