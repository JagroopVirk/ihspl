...
export default {
  ...
  image: {
    ...
    caption:
      "Identify and quantify leachables from packaging and devices into pharmaceuticals.",
  },
  pageContent: {
    hero: {
      heading:
        "Extractables & Leachables Testing for <span class='halfHeading'>Patient Safety</span>",
    ...
    overview: {
      heading:
        "Mastering E&L <span class='halfHeading'>Testing Excellence</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>E&L Testing Approach</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Packaging Safety?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert E&L Solutions",
