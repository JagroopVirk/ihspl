...
export default {
  ...
  image: {
    ...
    caption:
      "Toxicological evaluations for pharmaceutical safety and compliance.",
  },
  pageContent: {
    hero: {
      heading:
        "Toxicological Risk Assessments for <span class='halfHeading'>Pharmaceutical Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Toxicological <span class='halfHeading'>Risk Evaluations</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Toxicological Risk Assessment <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Product Safety?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert TRA Solutions",
  ...
  assessmentTypes: [
    "PDE Calculation",
    "Route-specific Toxicological Evaluation",
    "Cramer Classification",
  ],
};
