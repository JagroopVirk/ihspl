...
export default {
  ...
  image: {
    ...
    caption:
      "Animal-based genotoxicity assays for DNA damage and mutagenicity detection.",
  },
  pageContent: {
    hero: {
      heading:
        "In Vivo Genotoxicity Testing for <span class='halfHeading'>Regulatory Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering In Vivo <span class='halfHeading'>Genotoxicity Testing</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Genotoxicity Testing Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "In Vivo Genotoxicity <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Compound Safety?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Genotoxicity Solutions",
