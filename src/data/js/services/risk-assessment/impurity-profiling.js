...
export default {
  ...
  image: {
    ...
    caption:
      "Advanced identification and toxicological evaluation of pharmaceutical impurities.",
  },
  pageContent: {
    hero: {
      heading:
        "Impurity Profiling for <span class='halfHeading'>Regulatory Compliance</span>",
      tagline:
        "Precise Identification and Qualification for Pharmaceutical Safety",
      detail:
    ...
    overview: {
      heading:
        "Mastering Impurity <span class='halfHeading'>Profiling Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Impurity Profiling <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Impurity Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Profiling Solutions",
