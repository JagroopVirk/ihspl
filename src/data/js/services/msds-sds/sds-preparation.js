...
export default {
  ...
  image: {
    ...
    caption:
      "Professionally prepared SDS/MSDS for pharmaceutical regulatory and safety compliance.",
  },
  pageContent: {
    hero: {
      heading:
        "SDS/MSDS Preparation for <span class='halfHeading'>Global Compliance</span>",
      tagline:
        "Ensure Safe Handling with Regulatory-Compliant Safety Data Sheets",
      detail:
    ...
    overview: {
      heading:
        "Mastering Safety Data <span class='halfHeading'>Sheet Compliance</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "SDS/MSDS Preparation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>SDS Compliance?</span>",
      tagline:
      ...
      itemListElement: [
        {
          ...
          description:
            "Preparation of SDS/MSDS in the 16-section GHS format for global use.",
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          description:
            "Accurate hazard classification and precautionary statements as per CLP/GHS.",
        },
        {
          "@type": "Offer",
          name: "SDS for India, China, Japan",
          description:
            "Preparation of SDS in line with country-specific templates and regulatory formats.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    title:
      "SDS/MSDS Preparation Services | GHS, OSHA, REACH Compliant | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Pharma-grade SDS/MSDS documentation service for GHS, OSHA, EU REACH, and local compliance.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
