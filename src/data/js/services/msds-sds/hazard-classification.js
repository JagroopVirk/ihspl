...
export default {
  ...
  image: {
    ...
    caption:
      "GHS hazard labels with pictograms for regulated pharmaceutical containers.",
  },
  pageContent: {
    hero: {
      heading:
        "GHS-Compliant Hazard Classification & <span class='halfHeading'>Labeling</span>",
    ...
    overview: {
      heading:
        "Mastering Hazard <span class='halfHeading'>Classification & Labeling</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Hazard Classification & Labeling <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>GHS-Compliant Labeling?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Hazard Solutions",
  ...
  schema: {
    ...
    name: "Hazard Classification & Labeling",
    description:
      "Labeling and classification of chemical/pharmaceutical products per GHS and international standards.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Scientific classification of substances per global GHS guidelines.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Assignment of appropriate hazard pictograms and precautionary statements.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Design and validation of compliant labels for all packaging types.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Barcode generation and traceability support for labeled containers.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Hazard Classification & Labeling | GHS Compliance Services – Indivirtus",
    description:
