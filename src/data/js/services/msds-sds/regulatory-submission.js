...
export default {
  ...
  image: {
    ...
    caption:
      "Comprehensive support for global regulatory filings and technical dossier integration.",
  },
  pageContent: {
    hero: {
      heading:
        "Regulatory Submission Support for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Regulatory <span class='halfHeading'>Submissions</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Regulatory Submission <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description:
            "Support for BIS standard certification and CIB&RC agrochemical registrations in India.",
        },
        {
          "@type": "Offer",
          name: "ECHA REACH Registration",
          description:
            "Complete IUCLID dossier creation, data gap filling, and REACH joint submission support.",
        },
        {
          "@type": "Offer",
  ...
  meta: {
    title:
      "Regulatory Submission Services | EU, REACH, BIS, DMF Filing | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Complete regulatory dossier preparation and submission service for EU, India, and global filings.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
