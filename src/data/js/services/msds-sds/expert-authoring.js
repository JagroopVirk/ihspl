...
export default {
  ...
  description:
    "Toxicologist-led preparation and expert sign-off for globally compliant documentation.",
  full_description:
  ...
  pageContent: {
    hero: {
      heading:
        "Expert Authoring for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Expert <span class='halfHeading'>Documentation</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Compliant Documentation?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Authoring Solutions",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "Expert Review & Sign-Off",
            description:
              "All authored documents undergo peer review and sign-off by domain specialists.",
          },
        },
        {
          "@type": "Offer",
  ...
  meta: {
    title:
      "Expert Authoring | Toxicologist-Led Regulatory Documentation - Indivirtus",
    description:
