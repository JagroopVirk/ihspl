...
export default {
  ...
  description:
    "Pharmaceutical-grade toxicological evaluations using LD50, NOAEL, mutagenicity, and ECHA/TOXNET data.",
  full_description:
  ...
  image: {
    ...
    caption:
      "Comprehensive toxicological assessment for drug safety and regulatory compliance.",
  },
  pageContent: {
    hero: {
      heading:
        "Toxicological Assessments for <span class='halfHeading'>Pharma Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Toxicological <span class='halfHeading'>Evaluations</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Assessment Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Toxicological Assessment <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Toxicological Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Assessment Solutions",
      ...
      itemListElement: [
        {
          ...
          description:
            "Quantitative toxicity endpoints for acute and chronic exposure scenarios.",
        },
        {
          "@type": "Offer",
          name: "Mutagenicity & Genotoxicity Screening",
          description:
            "Interpretation of AMES, micronucleus, and chromosomal aberration test data.",
        },
        {
          "@type": "Offer",
          name: "Biodegradability Assessment",
          description:
            "OECD-guideline based assessment of environmental degradation potential.",
        },
        {
          "@type": "Offer",
          name: "ECHA & TOXNET Database Analysis",
          description:
            "Comprehensive literature and regulatory database review for toxicological endpoints.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    title:
      "Toxicological Assessment Services | LD50, NOAEL, Mutagenicity | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Comprehensive toxicology services including LD50, mutagenicity, NOAEL, and ECHA database reviews.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
