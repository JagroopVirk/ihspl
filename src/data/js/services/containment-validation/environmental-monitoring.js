...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Environmental Monitoring for <span class='halfHeading'>Cleanroom Compliance</span>",
    ...
    overview: {
      heading: "Mastering Environmental <span class='halfHeading'>Monitoring</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading: "Ready to Enhance Your <span class='halfHeading'>Cleanroom Monitoring?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services for Robust Contamination Control',
