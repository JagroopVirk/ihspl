...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Environmental Monitoring for <span class='halfHeading'>Cleanroom Excellence</span>",
      tagline:
        "Ensure Compliance and Quality with Robust Contamination Control",
      detail:
    ...
    overview: {
      heading:
        "Mastering Cleanroom <span class='halfHeading'>Environmental Monitoring</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Strengthen Your <span class='halfHeading'>Cleanroom Monitoring?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Comprehensive Contamination Control",
