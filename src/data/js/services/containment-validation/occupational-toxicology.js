...
export default {
  ...
  report_type:
    "Comprehensive Occupational Toxicology & Exposure Risk Assessment Report",
  title:
    "Pharmaceutical Occupational Toxicology Services | OEL/ADE/OEB | Indivirtus",
  ...
  estimated_duration:
    "5–12 days (varies by compound class and data availability)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Toxicologist reviewing API exposure risk data and OEB classification models",
  },
  pageContent: {
    hero: {
      heading:
        "Toxicological Evaluations for <span class='halfHeading'>Pharmaceutical Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Occupational <span class='halfHeading'>Toxicology</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Toxicology Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Toxicological Evaluation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      ...
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Toxicological Solutions",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "FMEA-based identification of critical exposure points with prioritized control measures.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Pharmaceutical Occupational Toxicology Services | OEL/ADE/OEB | GMP Compliance",
    description:
