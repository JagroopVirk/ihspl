...
export default {
  ...
  image: {
    ...
    caption:
      "Advanced smoke visualization for airflow pattern verification in ISO 5 cleanroom",
  },
  pageContent: {
    hero: {
      heading:
        "Precision Airflow Visualization for <span class='halfHeading'>Cleanroom Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Airflow <span class='halfHeading'>Visualization</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Visualization Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Airflow Visualization <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Enhance Your <span class='halfHeading'>Cleanroom Performance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Precision Airflow Validation",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Identification and documentation of turbulent zones with corrective action recommendations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "High-resolution video records with timestamped annotations for regulatory submissions.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Cross-contamination risk assessment through dynamic airflow boundary analysis.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "GMP Airflow Visualization Testing Service | Cleanroom Compliance | Indivirtus",
    description:
