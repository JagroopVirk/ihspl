...
export default {
  ...
  estimated_duration:
    "3–5 days (duration scales with facility complexity and sampling points)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Engineer conducting airborne particulate monitoring in API manufacturing suite",
  },
  pageContent: {
    hero: {
      heading:
        "SMEPAC-Based Containment for <span class='halfHeading'>Operator Safety</span>",
      tagline:
        "Ensure Compliance and Protect Your Workforce with Precision Validation",
      detail:
    ...
    overview: {
      heading:
        "Mastering Containment <span class='halfHeading'>Performance Testing</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Containment Validation Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Containment Validation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Secure Your <span class='halfHeading'>Containment Systems?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for SMEPAC-Based Safety and Compliance",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Personal and area monitoring to verify compliance with OELs and ALARP principles.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Quantitative performance grading using industry-standard containment benchmarks.",
          },
        },
        {
          "@type": "Offer",
  ...
  meta: {
    title:
      "SMEPAC Containment Testing for HPAPI Facilities | GMP Compliance | Indivirtus",
    description:
