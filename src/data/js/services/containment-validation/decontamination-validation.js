...
export default {
  ...
  title:
    "GMP Decontamination Validation Services | VHP & Cleaning Validation | Indivirtus",
  ...
  estimated_duration:
    "4–7 days (varies by facility size, product matrix, and validation approach)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Technician performing surface sampling for cleaning validation in sterile manufacturing suite",
  },
  pageContent: {
    hero: {
      heading:
        "Decontamination Validation for <span class='halfHeading'>Pharmaceutical Integrity</span>",
    ...
    overview: {
      heading:
        "Mastering Decontamination <span class='halfHeading'>Validation</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Decontamination <span class='halfHeading'>Validation Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Cleaning Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Robust Decontamination Validation",
  ...
  meta: {
    title:
      "Pharmaceutical Cleaning & VHP Decontamination Validation | GMP Compliance | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      title:
        "GMP Decontamination Validation Services | Pharma Cleaning Compliance",
      description:
