...
export default {
  ...
  image: {
    ...
    caption:
      "Toxicological Assessment for Safe Exposure Limits in Cleaning Validation",
  },
  pageContent: {
    hero: {
      heading:
        'ADE/PDE, OEL & <span class="halfHeading">Cleaning Validation Services</span>',
      tagline: "Ensuring Safe and Compliant Pharmaceutical Manufacturing",
    },
    main: {
      heading:
        'Our <span class="halfHeading">Cleaning Validation Services</span>',
      detail:
    ...
    process: {
      heading:
        'Our Cleaning <span class="halfHeading">Validation Process</span>',
      steps: [
        {
        ...
        },
        {
          title: "OEB Assignment",
          description:
            "We assign exposure bands to guide containment and facility segregation decisions.",
        },
        {
        ...
        },
        {
          ...
          description:
            "We prepare TRA reports and cross-contamination assessments to support compliance and audits.",
        },
        {
          title: "Regulatory Submission Support",
          description:
            "We provide documentation for PQRs and regulatory submissions, ensuring audit readiness.",
        },
      ],
    },
    compliance: {
    ...
    conclusion: {
      heading:
        'Why Choose Our <span class="halfHeading">Cleaning Validation Services?</span>',
      detail:
    ...
    cta: {
      ...
      tagline:
        "Partner with us for expert cleaning validation and exposure limit solutions.",
    },
  },
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description:
            "Calculation of safe exposure thresholds for manufacturing personnel handling potent APIs.",
        },
        {
          "@type": "Offer",
