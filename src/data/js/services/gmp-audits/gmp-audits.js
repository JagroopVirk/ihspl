...
export default {
  ...
  pageContent: {
    hero: {
      heading: "GMP Audit Services for <span class='halfHeading'>Pharmaceutical Excellence</span>",
      tagline: 'Ensure Compliance, Mitigate Risks, and Achieve Regulatory Success',
      detail:
    ...
    overview: {
      heading: "Understanding <span class='halfHeading'>GMP Compliance Audits</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading: "Our Expert <span class='halfHeading'>Approach to GMP Audits</span>",
      detail: [
    ...
    cta: {
      heading: "Ready to Strengthen Your <span class='halfHeading'>GMP Compliance?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services to achieve audit readiness and regulatory success.',
