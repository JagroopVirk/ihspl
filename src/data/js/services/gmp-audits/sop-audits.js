...
export default {
  ...
  image: {
    ...
    caption:
      "Comprehensive documentation audits including SOPs, batch records, and equipment logs",
  },
  pageContent: {
    hero: {
      heading:
        "SOP & Documentation Audits for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading:
        "The Importance of Robust <span class='halfHeading'>Documentation Systems</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert Approach to <span class='halfHeading'>Documentation Audits</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Documentation Audit <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    conclusion: {
      heading:
        "Why Choose Indivirtus for <span class='halfHeading'>Documentation Audits</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Optimize Your <span class='halfHeading'>Documentation Systems?</span>",
      tagline:
        "Partner with Indivirtus to ensure GMP-compliant, audit-ready documentation.",
  ...
  meta: {
    title:
      "SOP & Documentation Audits | Pharmaceutical GMP Review | Indivirtus",
    description:
