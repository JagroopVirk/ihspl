...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Audit Representation for <span class='halfHeading'>Regulatory Confidence</span>",
      tagline:
    ...
    overview: {
      heading:
        "Mastering Regulatory <span class='halfHeading'>Audit Representation</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Audit Support Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Audit Representation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ace Your <span class='halfHeading'>Regulatory Audit?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for expert audit support and compliance success.",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Design and documentation of corrective and preventive actions based on audit observations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Support for implementing agreed CAPAs and addressing any additional regulator queries.",
          },
        },
      ],
    },
