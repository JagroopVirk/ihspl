...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Facility Qualification for <span class='halfHeading'>Pharmaceutical Excellence</span>",
      tagline:
        "Ensure Compliance and Inspection Readiness with Expert Validation",
      detail:
    ...
    overview: {
      heading:
        "Understanding <span class='halfHeading'>Facility Qualification</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Qualification Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Facility Qualification <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Qualify Your <span class='halfHeading'>Pharmaceutical Facility?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services to ensure compliance and operational success.",
  ...
  schema: {
    ...
    name: "Facility Qualification",
    description:
      "DQ, IQ, OQ, PQ services and validation of pharmaceutical utilities.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            name: "DQ, IQ, OQ, PQ",
            description:
              "Design, Installation, Operational, and Performance Qualifications.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Validation of HVAC systems and cleaning procedures under controlled conditions.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "End-to-end validation of purified and WFI water systems.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Preparation and review of comprehensive VMP documents.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Facility Qualification | DQ, IQ, OQ, PQ, HVAC & Water Validation - Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "End-to-end validation services for GMP compliance with Indivirtus.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
