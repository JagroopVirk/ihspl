...
export default {
  ...
  estimated_duration:
    "Depends on product type & region – typically 7–15 working days",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Global regulatory strategy services including submission planning and authority engagement",
  },
  pageContent: {
    hero: {
      heading:
        "Strategic Regulatory Consulting for <span class='halfHeading'>Global Market Success</span>",
    ...
    overview: {
      heading:
        "Mastering Regulatory Strategy for <span class='halfHeading'>Pharmaceutical Success</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert Approach to <span class='halfHeading'>Regulatory Strategy</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Regulatory Strategy <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    conclusion: {
      heading:
        "Why Choose Indivirtus for <span class='halfHeading'>Regulatory Strategy</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>Regulatory Journey?</span>",
      tagline:
        "Partner with Indivirtus to achieve seamless compliance and faster market entry.",
