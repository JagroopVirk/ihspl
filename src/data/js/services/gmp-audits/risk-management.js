...
export default {
  ...
  image: {
    ...
    caption:
      "Risk management services including FMEA, HACCP, and ICH Q9 risk control strategies",
  },
  pageContent: {
    hero: {
      heading:
        "Comprehensive Risk Management <span class='halfHeading'>for Pharma Operations</span>",
      tagline:
    ...
    overview: {
      heading:
        "Why Risk Management is <span class='halfHeading'>Essential for Pharma</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert Approach to <span class='halfHeading'>Risk Management</span>",
      detail: [
    ...
    conclusion: {
      heading:
        "Why Choose Indivirtus for <span class='halfHeading'>Risk Management</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Mitigate Risks in <span class='halfHeading'>Your Operations?</span>",
      tagline:
        "Partner with Indivirtus for expert risk management audits that ensure compliance and safety.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Comprehensive audit and risk review aligned with ICH Q9 Quality Risk Management guidelines.",
          },
        },
        {
          "@type": "Offer",
