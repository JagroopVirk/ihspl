...
export default {
  ...
  description:
    "Site readiness, documentation, and audit support for successful pre-approval inspections.",
  full_description:
  ...
  image: {
    ...
    caption:
      "Inspection readiness and documentation support for smooth regulatory approvals.",
  },
  pageContent: {
    hero: {
      heading:
        "PAI Support for Seamless <span class='halfHeading'>Regulatory Success</span>",
    ...
    overview: {
      heading:
        "Why PAI Support is <span class='halfHeading'>Critical for Compliance</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Approach to PAI Success</span>",
      detail: [
    ...
    conclusion: {
      heading:
        "Why Choose <span class='halfHeading'>Indivirtus for PAI Support</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Ace Your <span class='halfHeading'>Pre-Approval Inspection?</span>",
      tagline:
        "Partner with Indivirtus to ensure regulatory compliance and market success.",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Comprehensive support in compiling and reviewing required PAI documents.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "On-ground or remote assistance during regulatory inspections.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Structured remediation plans addressing identified gaps post-inspection.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "PAI Support Services | Site Readiness & Audit Preparation - Indivirtus",
    description:
