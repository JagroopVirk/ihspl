...
export default {
  ...
  image: {
    ...
    caption:
      "Computer System Validation and data governance for GxP compliance.",
  },
  pageContent: {
    hero: {
      heading:
    ...
    overview: {
      heading:
        "Understanding Data <span class='halfHeading'>Integrity & CSV</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Secure Your <span class='halfHeading'>Data Integrity?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services to ensure compliance and system reliability.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Full lifecycle validation of computerized systems per GAMP 5 & GxP standards.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Assessment and remediation support for electronic records and signatures compliance.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Technical and procedural checks for audit trail availability, traceability, and security.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Assessment of data backup processes including periodicity, validation, and recovery.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Data Integrity & Computer System Validation | Indivirtus CRO Services",
    description:
