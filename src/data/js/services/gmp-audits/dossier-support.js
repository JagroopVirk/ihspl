...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Data Integrity & CSV for <span class='halfHeading'>Regulatory Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Data Integrity <span class='halfHeading'>& System Validation</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Data Integrity & CSV <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Data Integrity Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services to secure your systems and achieve regulatory success.",
  ...
  schema: {
    ...
    name: "Regulatory Dossier Support",
    description:
      "CTD/eCTD module preparation, NDA/ANDA/IND/DMF dossier compilation, and CMC documentation review.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Authoring and compilation of Modules 1–5 as per ICH and region-specific guidelines.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Complete support for global regulatory submissions across agencies.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Support for PAI documentation and regulatory inspection readiness.",
          },
        },
        {
          "@type": "Question",
  ...
  meta: {
    title:
      "Regulatory Dossier Support | CTD/eCTD, NDA, ANDA, DMF, MAA - Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Expert regulatory submission support for pharma and API manufacturers.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
