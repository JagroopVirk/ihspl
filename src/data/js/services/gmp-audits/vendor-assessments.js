...
export default {
  ...
  image: {
    ...
    caption:
      "Comprehensive vendor audits aligned with Schedule M and GMP standards",
  },
  pageContent: {
    hero: {
      heading:
        "Vendor Assessment Audits for <span class='halfHeading'>Pharmaceutical Excellence</span>",
      tagline:
        "Ensuring GMP Compliance and Quality Through Expert Vendor Audits",
      detail:
    ...
    overview: {
      heading:
        "Why Vendor Assessments Are <span class='halfHeading'>Critical for Compliance</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert Approach to <span class='halfHeading'>Vendor Assessments</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Vendor Assessment <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    conclusion: {
      heading:
        "Why Choose Indivirtus for <span class='halfHeading'>Vendor Assessments</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Strengthen Your <span class='halfHeading'>Vendor Ecosystem?</span>",
      tagline:
        "Partner with Indivirtus to ensure GMP compliance and quality with expert vendor assessments.",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Detailed gap identification and action plan mapping to align with Schedule M GMP guidelines.",
          },
        },
      ],
    },
