...
export default {
  ...
  description:
    "Expert regulatory support for FDA, EMA, PMDA, WHO PQ submissions, and lifecycle document handling.",
  full_description:
  ...
  pageContent: {
    hero: {
      heading:
        "Global Submission Support for <span class='halfHeading'>Regulatory Success</span>",
    ...
    deliverables: {
      heading:
        "Submission Support <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>Regulatory Submissions?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services to achieve timely approvals and global market success.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Regulatory dossier preparation and submission for global authorities.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Compilation and strategic drafting of regulatory query responses.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Lifecycle and variation handling for Drug Master Files and CEPs.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "End-to-end support for WHO Prequalification submissions and audits.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "Seamless regulatory submissions and global dossier handling support by Indivirtus Healthcare.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
