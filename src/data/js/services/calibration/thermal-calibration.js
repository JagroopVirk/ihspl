...
export default {
  ...
  estimated_duration:
    "3–5 working days (expedited 48-hour service for critical equipment)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Precision calibration of temperature sensors and stability chambers in controlled environment",
  },
  pageContent: {
    hero: {
      heading:
        'Thermal Calibration for <span class="halfHeading">Pharmaceutical Precision</span>',
      tagline:
    ...
    deliverables: {
      heading:
        'Thermal Calibration <span class="halfHeading">Deliverables</span>',
      itemList: [
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Non-contact thermometer calibration for personnel monitoring and surface temperature checks",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Autoclave and depyrogenation tunnel temperature profiling for sterilization processes",
          },
        },
      ],
    },
