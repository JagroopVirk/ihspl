...
export default {
  ...
  image: {
    ...
    caption:
      "Precision calibration of pH meters and conductivity probes in controlled laboratory environment",
  },
  pageContent: {
    hero: {
      heading:
        "Electrochemical & Flow Calibration for <span class='halfHeading'>Pharmaceutical Precision</span>",
      tagline:
    ...
    overview: {
      heading:
        "Mastering Electrochemical & Flow <span class='halfHeading'>Calibration</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Electrochemical & Flow Calibration <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>Process Precision?</span>",
      tagline:
