...
export default {
  ...
  image: {
    ...
    caption:
      "Precision calibration of multimeters and electrical test equipment in controlled laboratory environment",
  },
  pageContent: {
    hero: {
      heading:
        "Precision Calibration for <span class='halfHeading'>Pharmaceutical Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Calibration <span class='halfHeading'>Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Calibration Service <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Achieve <span class='halfHeading'>Precision Compliance?</span>",
      tagline:
  ...
  meta: {
    title:
      "NABL-Accredited Electro-Technical Calibration for Pharma | Indivirtus",
    description:
