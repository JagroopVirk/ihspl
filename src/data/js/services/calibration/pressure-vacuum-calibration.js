...
export default {
  ...
  estimated_duration:
    "3–5 working days (24-hour emergency service for critical process instruments)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Precision calibration of pressure transmitters and safety valves in controlled environment",
  },
  pageContent: {
    hero: {
      heading:
        "Pressure & Vacuum Calibration for <span class='halfHeading'>Pharmaceutical Precision</span>",
      tagline:
        "Ensure GMP Compliance with NABL-Accredited Calibration Solutions",
      detail:
    ...
    overview: {
      heading:
        "Mastering Pressure & Vacuum <span class='halfHeading'>Calibration</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Calibration Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Pressure & Vacuum Calibration <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>GMP Precision?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for NABL-Accredited Calibration Excellence",
  ...
  schema: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Magnehelic and digital manometer calibration for ISO 14644 cleanroom monitoring systems",
          },
        },
        {
          "@type": "Offer",
    ...
    offers: {
      ...
      price:
        "From ₹2,500 per instrument (package pricing for facility-wide calibration)",
      url: link,
  ...
  meta: {
    title:
      "NABL-Accredited Pressure/Vacuum Calibration for Pharma | Indivirtus",
    description:
