...
export default {
  ...
  estimated_duration:
    "3–5 working days (emergency 24-hour service available for critical equipment)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "Precision calibration of micrometers and tachometers in controlled laboratory environment",
  },
  pageContent: {
    hero: {
      heading:
        "Mechanical Calibration for <span class='halfHeading'>Pharmaceutical Precision</span>",
      tagline:
    ...
    overview: {
      heading:
        "Mastering Mechanical <span class='halfHeading'>Calibration</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Mechanical Calibration <span class='halfHeading'>Deliverables</span>",
      itemList: [
