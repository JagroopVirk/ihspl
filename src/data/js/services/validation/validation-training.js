...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Validation Training for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Validation & <span class='halfHeading'>Compliance Training</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Validation Training <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Empower Your <span class='halfHeading'>Compliance Team?</span>",
      tagline:
      ...
      itemListElement: [
        {
          ...
          description:
            "Hands-on training on computer system validation and GAMP 5 guidelines.",
        },
        {
          "@type": "Offer",
          name: "Data Integrity (ALCOA+)",
          description:
            "Workshops focusing on ALCOA+ principles and compliance with data integrity expectations.",
        },
        {
          "@type": "Offer",
          name: "Validation Strategy Workshops",
          description:
            "Practical workshops on planning and executing a robust validation strategy.",
        },
        {
          "@type": "Offer",
          name: "GxP System Training",
          description:
            "GxP compliance training covering quality systems, roles, and documentation best practices.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    ...
    twitterCard: {
      ...
      title: "Validation Training | CSV, GAMP 5, ALCOA+, GxP | Indivirtus",
      description:
        "Get regulatory-ready with professional pharma validation training services.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
