...
export default {
  ...
  service_id: "VAL-EMS",
  report_type:
    "IQ/OQ/PQ Protocols, Software Validation Reports, Calibration Certificates",
  ...
  image: {
    ...
    caption:
      "EMS validation including software compliance and environmental sensor calibration.",
  },
  pageContent: {
    hero: {
      heading:
        "EMS Validation for <span class='halfHeading'>GxP Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering EMS <span class='halfHeading'>Validation Excellence</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>EMS Validation Approach</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Validate Your <span class='halfHeading'>EMS Systems?</span>",
      tagline:
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Calibration of temperature, humidity, and pressure sensors with traceable standards.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      title:
        "EMS Validation | Environmental Monitoring System CSV | Indivirtus",
      description:
