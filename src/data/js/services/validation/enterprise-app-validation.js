...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Enterprise Application Validation for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading: "Mastering Enterprise <span class='halfHeading'>Validation Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading: "Enterprise Application Validation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Validate Your <span class='halfHeading'>Enterprise Systems?</span>",
