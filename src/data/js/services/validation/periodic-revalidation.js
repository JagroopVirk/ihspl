...
export default {
  ...
  image: {
    ...
    caption:
      "Ensure ongoing system compliance with lifecycle-based review and revalidation strategies",
  },
  pageContent: {
    hero: {
      heading:
        "Periodic Review & Revalidation for <span class='halfHeading'>System Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Lifecycle <span class='halfHeading'>Compliance Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Periodic Review & Revalidation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Maintain <span class='halfHeading'>System Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Revalidation Solutions",
  ...
  meta: {
    title:
      "Periodic Review & Revalidation | Pharma Lifecycle Compliance | Indivirtus",
    description:
  ...
  assessmentTypes: [
    ...
    "Revalidation Justification Report",
  ],
};
