...
export default {
  ...
  image: {
    ...
    caption:
      "Sensor-based mapping and validation of thermal performance for regulatory compliance",
  },
  pageContent: {
    hero: {
      heading:
        "Temperature Mapping & Validation for <span class='halfHeading'>Thermal Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Temperature <span class='halfHeading'>Mapping Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Temperature Mapping <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Validate Your <span class='halfHeading'>Thermal Environments?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Mapping Solutions",
  ...
  gtm: {
    ...
    eventLabel:
      "Temperature Mapping Services - Warehouse, Autoclave, Cold Room",
    customDimensions: {},
    dataLayerPush: {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description:
            "ISO-traceable calibration of temperature sensors and loggers used in mapping studies.",
        },
        {
          "@type": "Offer",
          name: "Graphical Data Analysis",
          description:
            "Visual heat maps and time-series reports with zone classification and deviation insights.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    title:
      "Temperature Mapping | Cold Room & Autoclave Validation | Indivirtus",
    description:
