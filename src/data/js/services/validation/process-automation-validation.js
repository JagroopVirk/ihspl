...
export default {
  ...
  image: {
    ...
    caption:
      "Validation of pharmaceutical automation systems with GAMP 5 and cybersecurity assurance",
  },
  pageContent: {
    hero: {
      heading:
        "Process Automation Validation for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Automation <span class='halfHeading'>Validation Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Process Automation Validation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Validate Your <span class='halfHeading'>Automation Systems?</span>",
      tagline:
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description:
            "Assessment of automation system security posture per IEC 62443 and FDA expectations.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    ...
    twitterCard: {
      ...
      title: "Process Automation Validation | PLC, SCADA, GAMP 5 | Indivirtus",
      description:
        "Ensure safe and compliant automation with our GAMP 5-based validation for pharma control systems.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
