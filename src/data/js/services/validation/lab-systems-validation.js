...
export default {
  ...
  image: {
    ...
    caption:
      "Ensure accuracy and compliance of your analytical instruments with robust lab system validation",
  },
  pageContent: {
    hero: {
      heading:
        "Laboratory Systems Validation for <span class='halfHeading'>Analytical Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Laboratory <span class='halfHeading'>Validation Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Laboratory Systems Validation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Validate Your <span class='halfHeading'>Analytical Systems?</span>",
      tagline:
  ...
  gtm: {
    ...
    eventLabel:
      "Laboratory Validation - HPLC, GC, Empower Software, 21 CFR Compliance",
    customDimensions: {},
    dataLayerPush: {
  ...
  meta: {
    title:
      "Laboratory Systems Validation | Analytical & CDS Qualification | Indivirtus",
    description:
