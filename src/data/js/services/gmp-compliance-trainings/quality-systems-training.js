...
export default {
  ...
  regulatory_basis: [
    ...
    "ICH Q9",
    "FDA 21 CFR Part 11",
    "WHO Guidelines on QMS & Data Integrity",
  ],
  ...
  image: {
    ...
    caption:
      "Training on ICH Q10, ALCOA+, CAPA, deviation handling, and ICH Q9 risk management",
  },
  pageContent: {
    hero: {
      heading:
        "Quality Systems Training for <span class='halfHeading'>Pharmaceutical Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Quality Systems <span class='halfHeading'>Compliance</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Quality Systems Training <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Strengthen Your <span class='halfHeading'>Quality Systems?</span>",
      tagline:
      ...
      itemListElement: [
        {
          ...
          description:
            "In-depth training on pharmaceutical quality systems and embedding a proactive quality culture.",
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          description:
            "Application of risk-based thinking in pharmaceutical operations based on ICH Q9 framework.",
        },
      ],
    },
    offers: {
