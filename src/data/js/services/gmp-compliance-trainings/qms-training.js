...
export default {
  ...
  image: {
    ...
    caption:
      "Master ICH Q10 and document control through interactive QMS training sessions.",
  },
  pageContent: {
    hero: {
      heading:
        "QMS Training for <span class='halfHeading'>Pharmaceutical Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Quality Management <span class='halfHeading'>Systems</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Elevate Your <span class='halfHeading'>Quality Systems?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert QMS Training",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Understanding and implementing the ICH Q10 model within your quality system.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Best practices for controlled document lifecycle, archival, and change management.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Evaluating and managing supplier quality systems, audits, and certifications.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Building systems for Annual Product Quality Review and performance metrics tracking.",
          },
        },
      ],
    },
