...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Training Methodologies for <span class='halfHeading'>Pharmaceutical Success</span>",
      tagline: 'Empower Your Team with Flexible, Role-Specific Learning Solutions',
      detail:
    ...
    overview: {
      heading: "Mastering Tailored <span class='halfHeading'>Training Solutions</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading: "Training Methodologies <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Empower Your <span class='halfHeading'>Pharma Team?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services for Tailored Training Excellence',
