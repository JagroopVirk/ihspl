...
export default {
  ...
  image: {
    ...
    caption:
      "Training on Revised Schedule M for Indian pharmaceutical GMP compliance",
  },
  pageContent: {
    hero: {
      heading:
        "Revised Schedule M Training for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Revised Schedule M <span class='halfHeading'>Compliance</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Revised Schedule M Training <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    compliance: {
      heading:
        "Regulatory Compliance & <span class='halfHeading'>Indian Standards</span>",
      detail: [
    ...
    cta: {
      heading:
        "Ready to Master <span class='halfHeading'>Revised Schedule M?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Compliance Training",
