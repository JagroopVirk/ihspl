...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "GxP Training for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    cta: {
      heading:
        "Ready to Master <span class='halfHeading'>GxP Compliance?</span>",
      tagline:
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Introduction to core GxP principles across development and manufacturing.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Understanding ICH E6 Good Clinical Practice and U.S. FDA’s manufacturing regulations.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Best practices for temperature-sensitive product handling and storage audits.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Training for clinical operations, ethics committees, and investigator sites.",
          },
        },
      ],
    },
