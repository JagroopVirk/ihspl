...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Cleaning Validation Training for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Cleaning Validation <span class='halfHeading'>Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Cleaning Validation Training <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Master <span class='halfHeading'>Cleaning Validation?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert GMP Training",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Techniques for identifying worst-case products for validation.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Calculation and justification of cleaning limits using MACO and PDE.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "GMP-compliant methods for residue recovery and validation.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Training on drafting and executing validation protocols and reports.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      title: "Cleaning Validation Training",
      description:
        "Master GMP cleaning validation concepts with expert-led, interactive sessions.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
