...
export default {
  ...
  pageContent: {
    hero: {
      heading: "GMP Training for <span class='halfHeading'>Pharmaceutical Excellence</span>",
    ...
    cta: {
      heading: "Ready to Elevate Your <span class='halfHeading'>GMP Compliance?</span>",
