...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Signal Management for <span class='halfHeading'>Pharmacovigilance Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Signal <span class='halfHeading'>Detection & Validation</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Signal Management Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Signal Management <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Enhance Your <span class='halfHeading'>Pharmacovigilance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Signal Management Solutions",
  ...
  schema: {
    ...
    name: "Signal Management",
    description:
      "Signal detection, validation, and regulatory communication for pharmacovigilance.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Quantitative methods to detect potential safety signals in large safety databases.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Structured analysis and expert review of detected signals for validity and causality.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Preparation of authority-facing safety reports, including responses to queries and updates.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "Expert signal detection, validation, and regulatory handling using advanced tools.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
