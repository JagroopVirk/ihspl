...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Global E2B Submissions for <span class='halfHeading'>Pharmacovigilance Compliance</span>",
    ...
    overview: {
      heading: "Mastering Global <span class='halfHeading'>Submission Excellence</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading: "Our Expert <span class='halfHeading'>Submissions Approach</span>",
      detail: [
    ...
    deliverables: {
      heading: "Global Submissions <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      ...
      tagline: 'Partner with Indivirtus Healthcare Services for Expert PV Reporting Solutions',
