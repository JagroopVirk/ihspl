...
export default {
  ...
  image: {
    ...
    caption:
      "Systematic literature screening of PubMed, Embase, and local sources for pharmacovigilance.",
  },
  pageContent: {
    hero: {
      heading:
        "GVP-Compliant Literature Monitoring for <span class='halfHeading'>Drug Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Literature <span class='halfHeading'>Monitoring Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Literature Monitoring <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Enhance Your <span class='halfHeading'>PV Monitoring?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Literature Solutions",
