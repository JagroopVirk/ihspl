...
export default {
  ...
  description:
    "Expert preparation of EU-RMPs, REMS, and lifecycle management of safety risk strategies.",
  full_description:
  ...
  pageContent: {
    hero: {
      heading:
        "Risk Management Plans for <span class='halfHeading'>Global Safety</span>",
    ...
    overview: {
      heading:
        "Mastering Risk <span class='halfHeading'>Management Excellence</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Risk Management Plan <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Enhance Your <span class='halfHeading'>Risk Management?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert RMP Solutions",
  ...
  schema: {
    ...
    name: "Risk Management Plan",
    description:
      "Preparation and lifecycle management of EU-RMPs and REMS for regulatory compliance.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Drafting of EU Risk Management Plans and FDA-compliant REMS strategies for product approval.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Identification and documentation of known and potential risks as part of RMP Module SVIII.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Ongoing updates, revision tracking, and global regulatory coordination for existing RMPs.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Risk Management Plan (RMP) Services | Pharmacovigilance | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Global RMP and REMS development and regulatory compliance for safer pharmaceutical products.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
  ...
  assessmentTypes: [
    "Risk Identification & RMM Planning",
    "Regulatory RMP/REMS Submission",
  ],
};
