...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Aggregate Safety Reporting for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading: "Mastering Aggregate <span class='halfHeading'>Safety Reporting</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading: "Aggregate Safety Reporting <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Streamline Your <span class='halfHeading'>Safety Reporting?</span>",
