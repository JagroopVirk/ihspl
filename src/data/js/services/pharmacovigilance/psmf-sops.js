...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "PSMF & SOPs Preparation for <span class='halfHeading'>Global Compliance</span>",
    ...
    deliverables: {
      heading:
        "PSMF & SOPs Preparation <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>PV Documentation Compliance?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert PSMF & SOP Solutions",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Preparation of Pharmacovigilance System Master File as per EU and UK standards.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Custom SOP development covering all pharmacovigilance activities per GVP guidance.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Structured annex documentation and controlled versioning aligned with QMS.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Integration of PV documentation into organization-wide quality systems.",
          },
        },
      ],
    },
  ...
  meta: {
    ...
    twitterCard: {
      ...
      description:
        "EMA and MHRA-compliant PSMF and SOPs preparation for PV systems.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
