...
export default {
  ...
  image: {
    ...
    caption:
      "24/7 multilingual medical call centre services for HCPs and patients",
  },
  pageContent: {
    hero: {
      heading:
        "24/7 Multilingual Medical Inquiry & <span class='halfHeading'>Complaint Triage</span>",
    ...
    overview: {
      heading:
        "Mastering Medical Inquiry & <span class='halfHeading'>Triage Services</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Medical Information Call Centre <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Enhance Your <span class='halfHeading'>PV Support?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert MICC Solutions",
      ...
      itemListElement: [
        {
          ...
          description:
            "Round-the-clock handling of HCP and patient inquiries with expert escalation protocols.",
        },
        {
          "@type": "Offer",
          name: "Multilingual Adverse Event Intake",
          description:
            "Trained agents collect and document AEs in local languages, with PV team escalation.",
        },
        {
          "@type": "Offer",
          name: "HCP & Patient Interaction",
          description:
            "Trained communication specialists manage sensitive medical information interactions.",
        },
        {
          "@type": "Offer",
          name: "Product Complaint Triage",
          description:
            "Initial intake, categorization, and regulatory escalation of product complaints.",
        },
      ],
    },
    offers: {
