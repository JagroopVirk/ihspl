...
export default {
  ...
  image: {
    ...
    caption:
      "Case intake, MedDRA coding, and global regulatory reporting through ICSR workflows.",
  },
  pageContent: {
    hero: {
      heading:
        "ICSR Case Processing for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering ICSR <span class='halfHeading'>Case Processing</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>ICSR Processing Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "ICSR Case Processing <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>ICSR Processing?</span>",
      tagline:
      ...
      itemListElement: [
        {
          ...
          description:
            "Clinical triage of case reports and accurate MedDRA coding for adverse events and indications.",
        },
        {
          "@type": "Offer",
