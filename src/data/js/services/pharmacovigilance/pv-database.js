...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Pharmacovigilance Database Setup for <span class='halfHeading'>Global Compliance</span>",
    ...
    overview: {
      heading: "Mastering PV <span class='halfHeading'>Database Solutions</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading: "Our Expert <span class='halfHeading'>Database Setup Approach</span>",
      detail: [
    ...
    deliverables: {
      heading: "PV Database Setup <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Deploy a <span class='halfHeading'>Compliant PV Database?</span>",
