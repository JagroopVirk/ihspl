...
export default {
  ...
  estimated_duration:
    "2–4 weeks (depending on isolator complexity and batch cycles)",
  deliverables: [
  ...
  pageContent: {
    hero: {
      heading:
        'Isolator Containment <span class="halfHeading">Validation Services</span>',
    ...
    cards: {
      heading:
        'Our Comprehensive <span class="halfHeading">Validation Services</span>',
      services: [
        {
          icon: "🧪",
          image: cpt,
      ...
      steps: [
        {
          ...
          description:
            "We collaborate to understand your isolator setup, compound potency, and compliance needs.",
        },
        {
          title: "Protocol Development",
          description:
            "We create SMEPAC-compliant protocols and sampling plans tailored to your facility.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Samples are analyzed by AIHA-accredited labs, and we deliver detailed validation reports.",
        },
        {
          title: "Certification & Support",
          description:
            "We issue containment certificates and provide ongoing regulatory and audit support.",
        },
      ],
    },
    compliance: {
    ...
    cta: {
      ...
      tagline:
        "Partner with us for expert isolator validation and compliance solutions.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Definition of CPT based on OEB/OEL and regulatory requirements.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Simulated operations using safe powders to test containment integrity.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Collection of samples near glove ports, gaskets, and liners to assess exposures.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Accredited analysis of collected samples and interpretation of results.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Comprehensive report reviewing data, identifying gaps, and advising next steps.",
          },
        },
      ],
    },
