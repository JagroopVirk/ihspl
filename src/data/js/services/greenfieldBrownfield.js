...
import feasibilityPlanning from "@/assets/greenfield-brownfield/feasibility-planning.jpg";
import conceptualDesign from "@/assets/greenfield-brownfield/conceptual-design.jpg";
import civilDesign from "@/assets/greenfield-brownfield/civil-design.jpg";
import utilityEngineering from "@/assets/greenfield-brownfield/utility-engineering.jpg";
import equipmentProcurement from "@/assets/greenfield-brownfield/equipment-procurement.jpg";
import gmpCompliance from "@/assets/greenfield-brownfield/gmp-compliance.jpg";
import validationServices from "@/assets/greenfield-brownfield/validation-services.jpg";
import constructionCommissioning from "@/assets/greenfield-brownfield/construction-commissioning.jpg";
import warehouseDesign from "@/assets/greenfield-brownfield/warehouse-design.jpg";
import ehsServices from "@/assets/greenfield-brownfield/ehs-services.jpg";
import qmsSetup from "@/assets/greenfield-brownfield/qms-setup.jpg";
import brownfieldUpgrades from "@/assets/greenfield-brownfield/brownfield-upgrades.jpg";
import digitalPharma from "@/assets/greenfield-brownfield/digital-pharma.jpg";
import projectManagement from "@/assets/greenfield-brownfield/project-management.jpg";
import postHandover from "@/assets/greenfield-brownfield/post-handover.jpg";
...
export default {
  ...
  estimated_duration:
    "6–18 months depending on scope and regulatory jurisdiction",
  deliverables: [
  ...
  pageContent: {
    hero: {
      heading:
        'Greenfield & Brownfield <span class="halfHeading">Pharmaceutical Projects</span>',
      tagline:
        "Building and Upgrading Compliant Facilities for Pharma Excellence",
    },
    main: {
    ...
    cta: {
      ...
      tagline:
        "Let us deliver turnkey solutions for your greenfield or brownfield project.",
    },
  },
  gtm: {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "From concept to commissioning of new FDF plants including layout, utilities, and validation.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Complete setup of new API facilities with compliance to cGMP and ICH Q7 standards.",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Retrofitting legacy API plants to meet current GMP expectations and regulatory requirements.",
          },
        },
      ],
    },
