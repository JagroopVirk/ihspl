...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Warehouse Design for <span class='halfHeading'>GMP Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering GMP Warehouse <span class='halfHeading'>Design</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Design a <span class='halfHeading'>GMP-Compliant Warehouse?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Storage Solutions",
  ...
  meta: {
    title:
      "GMP Warehouse Design & Layout | Cold Storage & Material Flow | Indivirtus",
    description:
  ...
  assessmentTypes: [
    "GMP Warehouse Layout Assessment",
    "Material Flow Audit",
