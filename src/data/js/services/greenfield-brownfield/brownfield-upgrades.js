...
export default {
  ...
  image: {
    ...
    caption:
      "Transform existing pharma facilities to GMP-compliant, efficient manufacturing plants",
  },
  pageContent: {
    hero: {
      heading:
        "Facility Upgrades for <span class='halfHeading'>GMP Compliance</span>",
    ...
    overview: {
      heading:
        "Mastering Facility <span class='halfHeading'>Modernization</span>",
      overviewCards: [
        {
    ...
    cta: {
      heading:
        "Ready to Upgrade Your <span class='halfHeading'>Pharma Facility?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Modernization Solutions",
