...
export default {
  ...
  image: {
    ...
    caption:
      "Vendor audits, sourcing, FAT/SAT, and equipment setup for pharma projects",
  },
  pageContent: {
    hero: {
      heading:
        "Equipment Procurement for <span class='halfHeading'>Pharma Compliance</span>",
      tagline:
        "Streamline Sourcing with Expert Vendor and Installation Support",
      detail:
    ...
    overview: {
      heading:
        "Mastering Equipment <span class='halfHeading'>Procurement</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Procurement Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Equipment Procurement <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>Equipment Procurement?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Sourcing Solutions",
