...
export default {
  ...
  regulatory_basis: [
    ...
    "USFDA/EMA Facility Design Considerations",
  ],
  ...
  pageContent: {
    hero: {
      heading:
        "Feasibility & Planning for <span class='halfHeading'>Pharma Facilities</span>",
    ...
    deliverables: {
      heading:
        "Feasibility & Planning <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Plan a <span class='halfHeading'>GMP-Compliant Facility?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Strategic Planning Excellence",
