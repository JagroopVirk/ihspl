...
export default {
  ...
  pageContent: {
    hero: {
      heading: "GMP Compliance Consulting for <span class='halfHeading'>Global Standards</span>",
    ...
    overview: {
      heading: "Mastering Global GMP <span class='halfHeading'>Compliance</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading: "Our Expert <span class='halfHeading'>Consulting Approach</span>",
      detail: [
    ...
    deliverables: {
      heading: "GMP Compliance Consulting <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Achieve <span class='halfHeading'>Global GMP Compliance?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services for Expert Consulting Solutions',
