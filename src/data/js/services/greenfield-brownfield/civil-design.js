...
export default {
  ...
  image: {
    ...
    caption:
      "Cleanroom-compliant facility layouts and structural design solutions for pharma plants",
  },
  pageContent: {
    hero: {
      heading:
        "Civil & Architectural Design for <span class='halfHeading'>Pharma Facilities</span>",
    ...
    overview: {
      heading:
        "Mastering Pharma Facility <span class='halfHeading'>Design</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Civil & Architectural Design <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Design a <span class='halfHeading'>GMP-Compliant Facility?</span>",
      tagline:
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description:
            "Design of ISO-classified cleanroom spaces compliant with ISO 14644 and GMP standards.",
        },
        {
          "@type": "Offer",
          name: "Seismic & Fire Safety Compliance",
          description:
            "Structural design with analysis and documentation for seismic zone and fire code compliance.",
        },
        {
          "@type": "Offer",
  ...
  meta: {
    title:
      "Civil & Architectural Design for Pharmaceutical Facilities | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "GMP-compliant civil and architectural designs for pharmaceutical manufacturing plants.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
