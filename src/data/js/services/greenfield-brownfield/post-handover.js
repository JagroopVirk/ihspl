...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Post-Handover Support for <span class='halfHeading'>Pharma Excellence</span>",
    ...
    overview: {
      heading:
        "Mastering Post-Handover <span class='halfHeading'>Compliance</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Post-Handover Support <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Achieve <span class='halfHeading'>Operational Excellence?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Post-Handover Support",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "APR/PQR Setup",
            description:
              "Implementation of Annual/Periodic Product Quality Review system per GMP guidelines.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Post-Handover Support Services | SOP Training, Audit Readiness, Maintenance Planning – Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Get expert SOP training, audit readiness support, and APR/PQR setup post facility handover.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
