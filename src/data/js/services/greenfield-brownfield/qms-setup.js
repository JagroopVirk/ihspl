...
export default {
  ...
  image: {
    ...
    caption:
      "Full QMS setup including SOPs, document control, and training for pharma companies",
  },
  pageContent: {
    hero: {
      heading:
        "QMS Setup for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    cta: {
      ...
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Quality Solutions",
