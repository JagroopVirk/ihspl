...
export default {
  ...
  image: {
    ...
    caption:
      "SCADA, eBMR/eBPR, IoT, serialization and digital compliance for GMP pharma",
  },
  pageContent: {
    hero: {
      heading:
        "Digital Pharma Integration for <span class='halfHeading'>Transformative Operations</span>",
    ...
    overview: {
      heading:
        "Mastering Digital <span class='halfHeading'>Transformation</span>",
      overviewCards: [
        {
    ...
    approach: {
      heading:
        "Our Expert <span class='halfHeading'>Digital Transformation Approach</span>",
      detail: [
    ...
    deliverables: {
      heading:
        "Digital Pharma Integration <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Transform Your <span class='halfHeading'>Pharma Operations?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Digital Solutions",
