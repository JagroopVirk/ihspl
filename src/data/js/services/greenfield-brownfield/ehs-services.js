...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "EHS Services for <span class='halfHeading'>Pharma Safety & Compliance</span>",
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>EHS Compliance?</span>",
      tagline:
  ...
  meta: {
    title:
      "EHS Services for Pharma | HAZOP, Fire Safety, Waste & Health Programs",
    description:
