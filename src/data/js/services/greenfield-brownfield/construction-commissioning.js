...
export default {
  ...
  image: {
    ...
    caption:
      "End-to-end construction and utility commissioning for GMP-compliant setups.",
  },
  pageContent: {
    hero: {
      heading:
        "Construction & Commissioning for <span class='halfHeading'>Pharma Facilities</span>",
    ...
    overview: {
      heading:
        "Mastering Construction & <span class='halfHeading'>Commissioning</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "Construction & Commissioning <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Build a <span class='halfHeading'>GMP-Compliant Facility?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Construction Solutions",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "End-to-end project execution and milestone-based coordination for facility construction.",
          },
        },
        {
          "@type": "Offer",
