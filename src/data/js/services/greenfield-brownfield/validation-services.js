...
export default {
  ...
  image: {
    ...
    caption:
      "Comprehensive GMP validation and qualification for pharma systems and processes",
  },
  pageContent: {
    hero: {
      heading:
        "Validation & Qualification for <span class='halfHeading'>Pharmaceutical Compliance</span>",
    ...
    deliverables: {
      heading:
        "Validation & Qualification <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Ensure <span class='halfHeading'>GMP-Compliant Facilities?</span>",
      tagline:
  ...
  meta: {
    title:
      "Validation & Qualification Services | GMP, CSV, Process | Indivirtus",
    description:
