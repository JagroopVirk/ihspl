...
export default {
  ...
  description:
    "Comprehensive EPCM project management solutions tailored for pharmaceutical facilities.",
  full_description:
  ...
  image: {
    ...
    caption:
      "Complete EPCM-based project management with dashboards and GMP compliance",
  },
  pageContent: {
    hero: {
      heading:
        "EPCM Solutions for <span class='halfHeading'>Pharmaceutical Projects</span>",
    ...
    overview: {
      heading:
        "Mastering Pharmaceutical <span class='halfHeading'>Project Management</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading:
        "EPCM Project Management <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Streamline Your <span class='halfHeading'>Pharma Project?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert EPCM Solutions",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            name: "EPCM Services",
            description:
              "Engineering, Procurement & Construction Management with compliance oversight.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Integrated management of project timelines, budget, and GMP quality.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Strategic planning for technical, regulatory, and logistical risks.",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Real-time project progress monitoring, KPIs, and analytics.",
          },
        },
      ],
    },
  ...
  meta: {
    title:
      "Turnkey Project Management for Pharmaceutical Facilities | Indivirtus",
    description:
  ...
  assessmentTypes: [
    "GMP Facility Planning",
    "Risk-based EPCM Review",
    "KPI-driven Project Audits",
  ],
};
