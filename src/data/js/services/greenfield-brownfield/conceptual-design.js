...
export default {
  ...
  pageContent: {
    hero: {
      heading:
        "Facility Design for <span class='halfHeading'>Pharma Excellence</span>",
    ...
    deliverables: {
      heading:
        "Conceptualization & Design <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading:
        "Ready to Optimize Your <span class='halfHeading'>Pharma Facility?</span>",
      tagline:
        "Partner with Indivirtus Healthcare Services for Expert Design Solutions",
  ...
  schema: {
    ...
    name: "Conceptualization & Design",
    description:
      "Modular, GMP-compliant facility layout and cleanroom design for pharmaceutical manufacturing.",
      ...
      itemListElement: [
        {
          ...
          description:
            "Design of optimal plant layouts that improve space utilization and GMP flow.",
        },
        {
          "@type": "Offer",
          name: "Modular & Prefab Design",
          description:
            "Implementation of modular cleanroom panels and prefab concepts to reduce construction time.",
        },
        {
          "@type": "Offer",
          name: "3D Modeling & BIM Integration",
          description:
            "BIM-based digital twin modeling for clash detection and cross-functional visibility.",
        },
        {
          "@type": "Offer",
          name: "Cleanroom Zoning",
          description:
            "Design of HVAC and pressure zoning layouts for sterile and non-sterile environments.",
        },
      ],
    },
    offers: {
  ...
  meta: {
    title:
      "Conceptual Facility Design | Pharmaceutical Plant Layout & Cleanroom Zoning",
    description:
    ...
    twitterCard: {
      ...
      description:
        "Optimize your pharma facility with BIM, cleanroom zoning & GMP-aligned conceptual layouts.",
      image: `https://www.indivirtus.com${link}.jpg`,
    },
