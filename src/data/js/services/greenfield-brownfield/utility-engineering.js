...
export default {
  ...
  pageContent: {
    hero: {
      heading: "Process & Utility Engineering for <span class='halfHeading'>Pharmaceutical Excellence</span>",
    ...
    overview: {
      heading: "Mastering Process & Utility <span class='halfHeading'>Engineering</span>",
      overviewCards: [
        {
    ...
    deliverables: {
      heading: "Process & Utility Engineering <span class='halfHeading'>Deliverables</span>",
      itemList: [
    ...
    cta: {
      heading: "Ready to Engineer a <span class='halfHeading'>GMP-Compliant Facility?</span>",
      tagline: 'Partner with Indivirtus Healthcare Services for Expert Engineering Solutions',
