...
export default {
  ...
  estimated_duration:
    "Ongoing service (duration based on regulatory timelines and product scope)",
  deliverables: [
  ...
  image: {
    ...
    caption:
      "End-to-end safety monitoring and compliance with global PV regulations",
  },
  pageContent: {
    hero: {
    ...
    main: {
      heading:
        'Our <span class="halfHeading">Pharmacovigilance Services</span>',
      detail:
    ...
    cta: {
      ...
      tagline:
        "Partner with us for expert pharmacovigilance solutions tailored to your needs.",
    },
  },
  gtm: {
  ...
  meta: {
    title:
      "Pharmacovigilance Services | Safety Reporting & Risk Management | Indivirtus",
    description:
    ...
    twitterCard: {
      ...
      description:
        "ICSR reporting, RMP, PSUR/PADER preparation, and full PV support under one CRO service umbrella.",
      image: `https://www.indivirtus.com${baseLink}.jpg`,
    },
